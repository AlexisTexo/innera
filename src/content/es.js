const content = {
  ...
  "modal": {
    ...
    "alreadyBody": "Este correo ya había sido registrado. Si no recibiste el email, revisa Spam/Promociones. Tu registro está confirmado.",
    "successTitle": "Registro confirmado",
    "successBody": "Tu solicitud fue recibida. Si el correo no llega en unos minutos, revisa Spam/Promociones.",
    "emailConfirmedBody": "Tu correo fue confirmado correctamente. ¡Gracias!",
  ...
  "ibp": {
    ...
    "intro": "Piensalo como la arquitectura de tu mundo interno: un mapa dinamico que traduce patrones, tendencias y ciclos en claridad accionable.",
    "cards": [
      {
  ...
  "early": {
    ...
    "intro": "Estamos formando un grupo fundador curado: personas que no solo usan herramientas, tambien ayudan a forjarlas. Tu insight pasa a formar parte del ADN de Innera.",
    "rows": [
      {
        "title": "Primer acceso",
