const content = {
  ...
  "modal": {
    ...
    "alreadyBody": "This email was already registered. If you didn't receive the email, please check Spam/Promotions. Your registration is confirmed.",
    "successTitle": "Registration confirmed",
    "successBody": "We received your application. If the email doesn't arrive in a few minutes, check Spam/Promotions.",
    "emailConfirmedBody": "Your email was confirmed successfully. Thank you.",
  ...
  "ibp": {
    ...
    "intro": "Think of it as the architecture of your inner world -- a dynamic map that translates your patterns, tendencies, and cycles into clear, actionable insight.",
    "cards": [
      {
  ...
  "early": {
    ...
    "intro": "We're assembling a curated founding group -- individuals who don't just use tools, but help forge them. Your insight becomes part of Innera's DNA.",
    "rows": [
      {
        "title": "First Access",
