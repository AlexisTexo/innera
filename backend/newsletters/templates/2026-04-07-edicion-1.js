module.exports = {
  ...
  html: (user) => {
    ...
    const i18n = isEn ? {
      ...
      section5Sub: 'Active perception vs. passive perception and its relationship to decision-making.',
      section5Url: 'https://www.theatlantic.com',
      section5Cta: 'Read article →',
      ...
      section5Body: `<strong>Why the brain is not an input-output machine</strong> — Anil Seth, The Atlantic`,
      section5Sub: 'Percepción activa vs. percepción pasiva y su relación con la toma de decisiones.',
      section5Url: 'https://www.theatlantic.com',
      section5Cta: 'Leer artículo →',
              ...
              <td style="background-color:#000000; padding:20px 24px 10px;" align="center">
                <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                  <tr>
                    ...
                    <td style="padding:0 8px;"><a href="https://www.facebook.com/" target="_blank" style="text-decoration:none;"><img src="https://img.icons8.com/ios-filled/50/FFFFFF/facebook-new.png" alt="Facebook" width="20" style="display:block; width:20px; height:20px; border:0;" /></a></td>
